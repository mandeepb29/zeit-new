...
var displayMousePositionHelper = function(event,innerItem,container) {
  
  var helper = innerItem.querySelector(".helper");
  console.log(helper,innerItem,container);
  var e = event || window.event;
  helper.innerHTML = mouse.show();
  helper.style.top = (e.clientY-container.offsetTop)+"px;";
  helper.style.left = (e.clientX-container.offsetLeft)+"px;";
};
